        ...
        <script type="text/javascript" src="/modulus/js/slick/slick.min.js"></script>
        <script src="/modulus/js/bootstrap.min.js"></script>
        <script src="/modulus/js/imagesloaded.pkgd.min.js"></script>
        <script src="/modulus/js/isotope.pkgd.min.js"></script>
        <script src="/modulus/js/jquery.appear.js"></script>
        <script src="/modulus/js/jquery.countTo.js"></script>
        <script src="/modulus/js/masonry.pkgd.min.js"></script>
        <script src="/modulus/js/owl.carousel.min.js"></script>
        <script src='/modulus/js/jquery.magnific-popup.min.js'></script>
        <script src="/modulus/js/global.js"></script>
        <script src="/modulus/js/main.js"></script>
    </body>
</html>