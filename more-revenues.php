...
<div class="main_more_revenue">

    <!-- Section Hero -->
    <section class="hero">
        <img src="/modulus/uploads/jetons-de-casino-modulus.png" alt="Jetons de casino Modulus" class="heroBetterPlayer">
    </section>
    <!-- END Section Hero -->
