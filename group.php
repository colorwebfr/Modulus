<?php
/*
* Template for displaying page Group
*/
?>
...
<div class="main_group">
    ...
    <div class="container">
      <div class="row">
        <div class="col-md-6 col-sm-6 col-xs-12 wow fadeInLeft equal-height-short" style="visibility: visible; animation-name: fadeInLeft;">
          <h2 class="title_Modulus h2_SUBhero light">AT MODULUS<br><span class="bold h2_SUBhero2">WE ARE</span></h2>
  ...
  <div class="page-section full-dark clearfix">
    ...
    <div class="fes7-img-cont col-md-6">
      <div class="fes7-img" style="background-image: url(/modulus/uploads/modulus_team_01.jpg);"></div>
    </div>
      ...
      <div class="row">
        <div class="col-md-6  ">
          <div class="fes2-main-text-cont">
            <p class="fes2-text-cont">Casino industry veteran and entrepreneur, Willy de Bruyn is the President of Modulus and heads our leadership team. That team includes decades of experience in the systems space and in-depth knowledge of the Galaxis and System2Go systems: Chief Operating Ofﬁcer Marc Attal comes with 30 years’ experience of the systems industry includes recent roles as COO at Ludi SFM and Managing Director at Atronic Chief Financial Ofﬁcer Frederic Bonafous has spent 25 years as the CFO of Atronic Systems. Director of Sales and Marketing, Fivos Polymniou is IGT’s former Sales Director for Systems
            </p>
          </div>
        </div>
        <div class="col-md-6 wow fadeInRight" style="visibility: visible; animation-name: fadeInRight">
          <div class="ads-img-cont">
            <img src="/modulus/uploads/modulus_team_02.jpg" alt="img">
          </div>
        </div>
      </div>
    </div>
  ...
  <section class="worldwide" style="background-image:url('/modulus/uploads/modulus_world.jpg');background-position:top;background-size:contain;background-repeat:no-repeat;">
    <div class="container">
      <h2 class="titleWorldwide">
        Modulus operates worldwide.<br>With offices and staff located<br> in EMEA, LAC and APAC.
      </h2>
    </div>
  </section>
  ...
  <section class="Casino_TrustUs">
    <div class="container">
      <h2 class="titleCasino_Trust text-center">350+ CASINOS TRUST US</h2>
      <div class="row containBoxLogos">
        <?php for ($n = 0; $n < 12; $n++) { ?>
          <?php
          $logoTrustUs = $n&1 ? "/modulus/uploads/logo_casino.png" : "/modulus/uploads/logo_partouche.png";
          ?>
          <div class="col-md-2 col-sm-4 col-xs-6 box_logosGroup">
            <img src="<?php echo $logoTrustUs ?>" alt="Logo des casinos partenaires de Modulus">
          </div>
        <?php } ?>
      </div>
    </div>
